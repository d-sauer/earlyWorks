...
Movie.Top = 0
Movie.Left = 0
Movie.Width = GLF.Width - 200
Movie.Height = GLF.Height - (2 * GLF.Picture1.Height) - 70
Movie.Show
    Call RefreshMovie 'Refresh
Case 2
Game.Top = 0
Game.Left = 0
Game.Width = GLF.Width - 200
Game.Height = GLF.Height - (2 * GLF.Picture1.Height) - 70
Game.Show
    Call RefreshGame 'Refresh
Case 3
Programs.Top = 0
Programs.Left = 0
Programs.Width = GLF.Width - 200
Programs.Height = GLF.Height - (2 * GLF.Picture1.Height) - 70
Programs.Show
    Call RefreshProg 'Refresh
End Select
End Sub
