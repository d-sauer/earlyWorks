...
Music.List2.AddItem Trim(TX1 & "!!" & GLF.cdb(5).Text)
    Music.PBar.Max = (GLF.Lnk.Recordset.RecordCount / 2)
...
'------------------- umetnut petlju ------------------------
    Music.PBar.Visible = True
    Music.PBar.Max = Fix(Music.List1.ListCount / 2)
    
For QN1 = 0 To Music.List1.ListCount - 1
    Music.PBar.Value = QN1
...
STR = "Artist='" & _
    STR & "'"
Music.PBar.Max = Fix(GLF.Lnk.Recordset.RecordCount / 4) '<<<---
...
For A2 = 0 To a
Music.PBar.Value = Fix(GLF.Lnk.Recordset.AbsolutePosition / 4) '<<<----
...
Music.PBar.Max = Fix(Music.List4.ListCount / 2)
For w1 = 0 To Music.List4.ListCount - 1
Music.PBar.Value = Fix(w1 / 2)
...
Music.PBar.Max = Fix(Music.List5.ListCount / 2)
...
Music.PBar.Max = Fix(Music.List6.ListCount / 2)
...
Music.PBar.Max = Fix(GLF.Lnk.Recordset.RecordCount / 2) + 1
GLF.Lnk.Recordset.MoveFirst
...
GLF.Lnk.Recordset.MoveFirst
Music.PBar.Visible = True
Music.PBar.Max = GLF.Lnk.Recordset.RecordCount + 1
...
For N = 1 To GLF.Lnk.Recordset.RecordCount
Music.PBar.Value = N ': GLF.Caption = N
