...
<div id="main">
	...
	<h1>Došlo je do pogreške</h1>
    	<?php
			switch($_GET['msg']) {
				case 0:
					echo "<p>Pogreška prilikom registracije. Pokušajte ponovo.</p>";
					break;
				case 1:
					echo "<p>Došlo je do pogreške prilikom registracije korisničkog računa<br/>Pokušajte ponovo.</p>";
					break;
				case 2:
					echo "<p>Došlo je do pogreške u radu servisa! <br/>Pokušajte kasnije ponovo.</p>";
					break;
				case 3:
					echo "<p>Niste se prijavljeni na sustav kao osoblje smještajnog objekta!<br/>Prijavite se na sustav!</p>";
					break;
				case 4:
				...
				case 5:
					...
					break;					
				case 6:
					echo "<p>Korisnik nema dovoljnu svotu na računu, da bi podmirio trenutnu stanje transakcije!</p>";
					break;					
